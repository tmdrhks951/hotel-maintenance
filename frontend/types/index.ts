...
export const WORK_ACTION_ITEMS: Record<WorkAction, Partial<Record<RequestCategory, string[]>>> = {
  수리: {
    SILICONE:   ['실리콘 재마감', '메지 재마감', '방수 보수', '코킹 보수'],
    WALLPAPER:  ['벽지 들뜸 보수', '시트지 재마감', '모서리 보수', '찢어짐 보수'],
    PAINTING:   ['도장 터치업', '얼룩 도장', '부분 재도장'],
    FURNITURE:  ['휴지걸이 재고정', '수건걸이 재고정', '선반 재고정', '서랍 수리', '경첩 조정'],
    LIGHTING:   ['등기구 재고정', '배선 수리', '안정기 수리'],
    PLUMBING:   ['누수 보수', '배수관 수리', '수전 수리', '변기 수리', '밸브 수리'],
    DOOR:       ['도어 경첩 조정', '손잡이 수리', '도어 클로저 조정', '창문 수리'],
    APPLIANCE:  ['TV 수리', '리모컨 점검', 'IT 장비 수리'],
    HVAC:       ['에어컨 수리', '환기팬 수리', '필터 청소'],
    ELECTRICAL: ['콘센트 수리', '스위치 수리', '차단기 점검'],
    SAFETY:     ['비상구 수리', '감지기 수리', '안전장비 수리'],
    OTHER:      ['기타 수리'],
  },
  교체: {
    SILICONE:   ['실리콘', '메지', '방수 시트', '코킹재'],
    WALLPAPER:  ['벽지', '시트지', '도배'],
    PAINTING:   ['페인트 재도장', '프라이머 재도장'],
    FURNITURE:  ['경첩', '손잡이', '휴지걸이', '수건걸이', '선반', '의자 바퀴'],
    LIGHTING:   ['T5등', 'LED', '매립등', '전구', '형광등', '등기구'],
    PLUMBING:   ['수도꼭지', '샤워헤드', '변기 부품', '밸브', '배수 트랩', '호스'],
    DOOR:       ['도어록', '도어 클로저', '창문 잠금장치', '도어 패킹'],
    APPLIANCE:  ['TV', '리모컨', '배터리', '케이블', '셋톱박스'],
    HVAC:       ['필터', '리모컨', '배터리', '온도조절기'],
    ELECTRICAL: ['콘센트', '스위치', '차단기', '배선기구'],
    SAFETY:     ['화재감지기', '소화기', '비상등 배터리'],
    OTHER:      ['기타 교체'],
  },
  점검: {
    SILICONE:   ['실리콘 상태 점검', '방수 점검', '메지 상태 확인'],
    WALLPAPER:  ['벽지 상태 점검', '들뜸 여부 확인'],
    PAINTING:   ['도장 상태 점검', '변색 확인'],
    FURNITURE:  ['가구 고정 상태 점검', '흔들림 확인'],
    LIGHTING:   ['조명 작동 점검', '밝기 확인'],
    PLUMBING:   ['전체 배관 점검', '누수 여부 확인', '수압 점검'],
    DOOR:       ['도어 개폐 점검', '잠금장치 점검', '창문 작동 점검'],
    APPLIANCE:  ['TV 작동 점검', '채널 점검', '리모컨 점검'],
  ...
  임시조치: {
    SILICONE:   ['임시 실링', '방수 테이프 부착'],
    WALLPAPER:  ['임시 부착', '테이프 고정'],
    PAINTING:   ['임시 가림', '사용 제한 표시'],
    FURNITURE:  ['임시 고정', '사용 제한 표시'],
    LIGHTING:   ['임시 조명 설치', '사용 중지 표시'],
    PLUMBING:   ['지수 밸브 잠금', '임시 배관 연결', '버킷 설치'],
    DOOR:       ['임시 잠금', '사용 제한'],
    APPLIANCE:  ['전원 차단', '사용 제한'],
    HVAC:       ['임시 운전 중단', '필터 임시 교체'],
    ELECTRICAL: ['임시 차단 조치', '절연 테이프 처리'],
    SAFETY:     ['임시 경보 비활성화', '안전구역 설정'],
    OTHER:      ['임시 처리'],
  },
  외주: {
    SILICONE:   ['실리콘 전문업체 의뢰', '방수 전문업체 의뢰'],
    WALLPAPER:  ['도배 전문업체 의뢰', '시트지 전문업체 의뢰'],
    PAINTING:   ['도장 전문업체 의뢰'],
    FURNITURE:  ['가구 전문업체 의뢰'],
    LIGHTING:   ['조명 전문업체 의뢰'],
    PLUMBING:   ['배관 전문업체 의뢰'],
    DOOR:       ['도어 전문업체 의뢰', '창호 전문업체 의뢰'],
    APPLIANCE:  ['가전 AS 의뢰'],
    HVAC:       ['냉난방 전문업체 의뢰'],
    ELECTRICAL: ['전기 전문업체 의뢰'],
    SAFETY:     ['소방 전문업체 의뢰', '안전 전문업체 의뢰'],
    OTHER:      ['외주 의뢰'],
  },
  보류: {
    SILICONE:   ['자재 대기', '예산 검토 필요'],
    WALLPAPER:  ['자재 대기', '예산 검토 필요'],
    PAINTING:   ['자재 대기', '예산 검토 필요'],
    FURNITURE:  ['부품 대기', '예산 검토 필요'],
    LIGHTING:   ['부품 대기', '예산 검토 필요'],
    PLUMBING:   ['부품 대기', '예산 검토 필요'],
    DOOR:       ['부품 대기', '예산 검토 필요'],
    APPLIANCE:  ['부품 대기', '예산 검토 필요'],
    HVAC:       ['부품 대기', '예산 검토 필요'],
